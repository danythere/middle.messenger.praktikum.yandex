...
export const getConfig = (eventHandlers: {
   ...
   messages: [
      ...
      { text: 'Первый блин — комом', author: true },
      { text: 'Один в поле не воин', author: false },
      {
      ...
      { text: 'Уродится не уродится, а паши', author: true },
      { text: 'Семь раз отмерь — один отрежь', author: true },
      {
